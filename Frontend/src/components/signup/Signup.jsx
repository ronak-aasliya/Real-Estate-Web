...
import { AiOutlineFileImage, AiOutlineFontSize } from 'react-icons/ai'
...
const Signup = () => {
  ...
  const iconStyles = { color: "black", fontSize: "1.5em" };
  return (
    <div className={classes.container}>
      <div className={classes.wrapper}>
        ...
        <form onSubmit={handleRegister}>
          ...
          <label htmlFor='photo'>Upload photo <AiOutlineFileImage style={iconStyles} /></label>
